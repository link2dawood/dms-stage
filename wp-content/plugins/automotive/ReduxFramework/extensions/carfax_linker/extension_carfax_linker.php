...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_carfax_linker' ) ) {
    ...
    class ReduxFramework_extension_carfax_linker extends ReduxFramework {
