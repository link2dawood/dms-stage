...
if( !class_exists( 'ReduxFramework_custom_badges' ) ) {
    ...
    class ReduxFramework_custom_badges extends ReduxFramework {
        ...
        public function render() {
	        ...
	        echo '<li><div class="color_picker_container"><span style="text-align: left; margin-bottom: 3px;" class="topLabel">' . __("Sold Badge", "redux-framework") . '</span><input type="text" name="' . $this->field['name'] . $this->field['name_suffix'] . '[name][sold]' . '" placeholder="' . __("Sold Badge Name", "redux-framework") . '" value="' . $sold_value . '" style="margin-right: 6px;"></div>';

	        echo '<div class="color_picker_container"><span class="topLabel">' . __('Badge Color', 'redux-framework') . '</span><input data-id="' . $this->field['id'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[color][sold]' . '" id="' . $this->field['id'] . '-color" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" value="' . $sold_color . '" data-oldcolor=""  data-default-color="' . ( isset( $this->field['default'] ) ? $this->field['default'] : "" ) . '" />';
	        echo '<input type="hidden" class="redux-saved-color" id="' . $this->field['id'] . '-saved-color' . '" value=""></div>';

	        echo '<div class="color_picker_container"><span class="topLabel">' . __('Badge Font', 'redux-framework') . '</span><input data-id="' . $this->field['id'] . '-font" name="' . $this->field['name'] . $this->field['name_suffix'] . '[font][sold]' . '" id="' . $this->field['id'] . '-color" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" value="' . $sold_font . '" data-oldcolor=""  data-default-color="' . ( isset( $this->field['default'] ) ? $this->field['default'] : "" ) . '" />';
	        echo '<input type="hidden" class="redux-saved-color" id="' . $this->field['id'] . '-saved-color' . '" value=""></div>';
            ...
            if ( isset( $this->value['name'] ) && is_array( $this->value['name'] ) ) {
                ...
                foreach ( $this->value['name'] as $k => $value ) {
                    if ( !empty($value) ) {
                        ...
                        echo '<li class="custom-badge-color-row"><input type="text" name="' . $this->field['name'] . $this->field['name_suffix'] . '[name][' . $k . ']' . '" placeholder="' . __("Badge Name", "redux-framework") . '" value="' . $value . '" style="margin-right: 6px;">';
	        ...
	        /* Hidden Custom Badge */
            echo '<li class="custom-badge-color-row" style="display:none;"><input type="text" name="' . $this->field['name'] . $this->field['name_suffix'] . '[name][]' . '" placeholder="' . __("Badge Name", "redux-framework") . '" style="margin-right: 6px;">';
