...
// add custom height field to VC row
function auto_visual_composer_row_height() {
	if(apply_filters('automotive_disable_custom_vc_row', false) === false){
...
function automotive_vc_shortcodes() {
	...
	if(is_admin() || isset($_GET['vc_editable']) && $_GET['vc_editable'] == 'true'){
		// quote
		vc_map( array(
		...
		// woocommerce product scroller
		vc_map( array(
			"name"     => __( "WooCommerce Product Scroller", "listings" ),
			"base"     => "woocommerce_product_scroller",
			"class"    => "",
			"category" => __( 'Automotive Shortcodes', "listings" ),
			"params"   => array(
				array(
		...
		$inventory_vc = array(
			...
			"params"   => array(
				array(
					...
					"description" => __( "The listings display layout", "listings" )
				),
				array(
					"type"        => "dropdown",
					"holder"      => "",
				...
				array(
					...
					"value"       => array(
						__( "Dropdown filters", "listings" )    => "dropdown_filters",
						__( "Sort by dropdown", "listings" )    => "sortby_dropdown",
						__( "Reset Filter Button", "listings" ) => "reset_button",
						__( "Vehicles Matching", "listings" )   => "vehicles_matching",
						__( "Select View", "listings" )         => "select_view"
					),
				...
				array(
					...
					"holder"      => "",
					"class"       => "",
					"heading"     => __( "Hide Views", "listings" ),
					"param_name"  => "hide_views",
					"value"       => array(
						__( "Wide Fullwidth", "listings" )    	=> "wide_fullwidth",
						__( "Wide Sidebar Left", "listings" )   => "wide_left",
						__( "Wide Sidebar Right", "listings" )  => "wide_right",
						__( "Boxed Fullwidth", "listings" ) 		=> "boxed_fullwidth",
						__( "Boxed Sidebar Left", "listings" )  => "boxed_left",
						__( "Boxed Sidebar Right", "listings" ) => "boxed_right"
					),
					"description" => __( "Check off any views you don't want to be shown on the frontend.", "listings" )
				)
			)
		);
		...
		if ( ! empty( $vc_listing_categories ) ) {
			$inventory_vc['params'] = array_merge( $inventory_vc['params'], $vc_listing_categories );
		}
		...
		vc_map( array(
			...
			"params"          => array(
				array(
					...
					"param_name"  => "icon",
					"value"       => "",
					"description" => __( "Icon used for the list items. <a href='https://fontawesome.com/v4.7.0/icons/' target='_blank'>List of Icons</a>", "listings" )
				),
				array(
					"type"        => "textarea_html",
					"holder"      => "div",
		...
		vc_map( array(
			...
			"params"   => array(
				array(
					...
					"param_name"  => "icon",
					"value"       => "",
					"description" => __( "Icon to display above the number. <a href='https://fontawesome.com/v4.7.0/icons/' target='_blank'>List of Icons</a>", "listings" )
				),
				array(
					"type"        => "textfield",
					"holder"      => "div",
		...
		vc_map( array(
			...
			"params"   => array(
				...
				array(
					...
					"param_name"  => "icon",
					"value"       => "",
					"description" => __( "Icon of the featured box (fa fa-users) <a href='https://fontawesome.com/v4.7.0/icons/' target='_blank'>List of Icons</a>.", "listings" )
				),
				array(
					"type"        => "textfield",
					"heading"     => __( "Extra class name", "listings" ),
		...
		vc_map( array(
			...
			"params"   => array(
				...
				array(
					...
					"param_name"  => "icon",
					"value"       => "",
					"description" => __( "Icon to show beside the title. <a href='https://fontawesome.com/v4.7.0/icons/' target='_blank'>List of Icons</a>", "listings" )
				),
				array(
					"type"        => "attach_image",
					"holder"      => "div",
		...
		vc_map( array(
			...
			"params"   => array(
				...
				array(
					"type"        => "dropdown",
					"class"       => "",
					"heading"     => __( "Order by", "listings" ),
					"param_name"  => "order_by",
					"value"       => array(
						__( "Ascending", "listings" )  => "ASC",
						__( "Descending", "listings" ) => "DESC"
					),
					"description" => __( "Change the order of the portfolio items", "listings" )
				)
			)
		) );
		...
		vc_map( array(
			...
			"params"                  => array(
				...
				array(
					"type"        => "colorpicker",
					"class"       => "",
					"heading"     => __( "Header Color", "listings" ),
					"param_name"  => "header_color",
					"value"       => __( "#c7081b", "listings" ),
					"description" => __( "Customize the color of the pricing header", "listings" )
				),
				array(
					"type"        => "textfield",
					"class"       => "",
		...
		vc_map( array(
			...
			"params"   => array(
				array(
					...
					"description" => __( "Dropdowns that will be shown in the first column (leave column 2 blank to extend this column to fullwidth)", "listings" )
				),
				array(
					"type"        => "checkbox",
					"class"       => "",
				...
				array(
					...
					"param_name"  => "page_id",
					"description" => __( "Choose the Inventory page which you want to display the search results", "listings" )
				),
				array(
					"type"        => "dropdown",
		...
		if ( ! empty( $vc_listing_categories ) ) {
			$vehicle_scroller_params = array_merge( $vehicle_scroller_params, $vc_listing_categories );
		}
		...
		vc_map( array(
			...
			"class"    => "",
			"category" => __( 'Automotive Shortcodes', "listings" ),
			"params"   => $vehicle_scroller_params
		) );
		...
		vc_map( array(
			...
			"params"   => array(
				...
				array(
					"type"        => "dropdown",
					"class"       => "",
					"heading"     => __( "Button Alignment", "listings" ),
					"param_name"  => "align",
					"value"       => array(
						__("Left", "listings")   => "left",
						__("Center", "listings") => "center",
		...
		vc_map( array(
			...
			"params"   => array(
				array(
					...
					"holder"      => "div",
					"class"       => "",
					"heading"     => __( "Dropcap letter", "listings" ),
					"param_name"  => "content",
					"value"       => "",
					"description" => ""
				),
		...
		vc_map( array(
			...
			"params"   => array(
				...
				array(
					"type"        => "dropdown",
					"class"       => "",
					"heading"     => __( "Video Quality", "listings" ),
					"param_name"  => "vq",
					"value"       => array(
						"144p"  => "tiny",
						"240p"  => "small",
		...
		vc_map( array(
			...
			"params"   => array(
				array(
					"type"        => "dropdown",
					"heading"     => __( "Alignment", "listings" ),
					"param_name"  => "align",
					"value"       => array(
						__( "Left",  "listings" ) => "left",
						__( "Right", "listings" ) => "right"
					),
					"description" => __( "Change the style of the Google Map.", "listings" )
				),
				array(
					"type"        => "textfield",
					"heading"     => __( "Extra class name", "listings" ),
		...
		vc_map( array(
			...
			"params"   => array(
				...
				array(
					...
					"param_name"  => "map_type",
					"value"       => array(
						__( "Roadmap", "listings" )   => "roadmap",
						__( "Satellite", "listings" ) => "satellite",
						__( "Hybrid", "listings" )    => "hybrid",
						__( "Terrain", "listings" )   => "terrain"
					),
					"description" => __( "Change the style of the Google Map.", "listings" )
				),
				array(
		...
		vc_map( array(
				...
				"params"   => array(
					...
					array(
						...
						"param_name"  => "icon",
						"value"       => "",
						"description" => __( "e.g. fa fa-dashboard <a href='https://fontawesome.com/v4.7.0/icons/' target='_blank'>List of Icons</a>", "listings" )
					),
					array(
						"type"        => "vc_link",
						"class"       => "",
		...
		vc_map( array(
				"name"     => __( "Automotive Form", "listings" ),
				...
				"params"   => array(
					array(
						"type"        => "dropdown",
						"heading"     => __( "Form", "listings" ),
						"param_name"  => "form",
						"value"       => array(
							__( "Choose a form", "listings" )				=> "",
							__( "Request More Info", "listings" )   => "request",
							__( "Schedule Test Drive", "listings" ) => "schedule",
							__( "Make an Offer", "listings" )    	  => "make_offer",
							__( "Trade-In Appraisal", "listings" )  => "trade_in",
							__( "Email to a Friend")							  => "email_friend"
						),
						"description" => __( "Choose which form will be displayed.", "listings" )
					)
				)
			)
		);
