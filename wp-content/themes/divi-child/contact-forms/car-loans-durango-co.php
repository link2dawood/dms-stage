<?php 
function divi_child_car_loans_contact_form() {
    ob_start(); // Start output buffering
    ?>
    <div class="global-form-wrapper car-loans-form-wrapper">
        <div class="global-form-form">
            <?php echo do_shortcode('[contact-form-7 id="6896" title="multistep form"]'); ?>
        </div>
...
add_shortcode('car_loans_contact_form','divi_child_car_loans_contact_form');
?>
