<?php 
function divi_child_contact_us_form() {
    ob_start(); // Start output buffering
    ?>
    <div class="global-form-wrapper">
        <div class="global-form-form">
            <?php echo do_shortcode('[contact-form-7 id="6918" title="Contact us Form"]'); ?>
        </div>
...
add_shortcode('contact_us_form','divi_child_contact_us_form');
?>
