<?php 
function divi_child_auto_parts_durango_contact_form() {
    ob_start(); // Start output buffering
    ?>
    <div class="global-form-wrapper">
        <div class="global-form-form">
            <?php echo do_shortcode('[contact-form-7 id="141825" title="Autoparts durango co"]'); ?>
        </div>
...
add_shortcode('auto_parts_durango_co_form','divi_child_auto_parts_durango_contact_form');
?>
