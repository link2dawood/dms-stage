<?php 
function divi_child_co_applicant_contact_form() {
    ob_start(); // Start output buffering
    ?>
    <div class="global-form-wrapper car-loans-form-wrapper">
        <div class="global-form-form">
            <?php echo do_shortcode('[contact-form-7 id="45503" title="Co-applicant multistep form"]'); ?>
        </div>
...
add_shortcode('co_applicant_contact_form','divi_child_co_applicant_contact_form');
?>
