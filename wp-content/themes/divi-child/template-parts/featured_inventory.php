...
function dmc_manager_specials() {
    ...
    if ($stockNumbers && !empty($stockNumbers)) {
        ...
        if (!empty($vins)) {
            // Add CSS styles scoped to manager-specials-row only
            $output .= '<style>
                .manager-specials-row .listing-image-slider.MySlider .listing-image-slider-inner .slick-dots li {
                    width: 16px !important;
                    height: 16px !important;
                }
                .manager-specials-row .listing-image-slider.MySlider .listing-image-slider-inner .slick-dots li button {
                    width: 16px !important;
                    height: 16px !important;
                }
                .manager-specials-row .listing-image-slider.MySlider .listing-image-slider-inner .slick-dots li.slick-active {
                    width: 24px !important;
                }
                .manager-specials-row .listing-image-slider.MySlider .listing-image-slider-inner .slick-dots li.slick-active button {
                    width: 24px !important;
                    height: 16px !important;
                ...
                .manager-specials-row .btn:hover{
                        ...
                        <div class="card-image-wrapper overflow-hidden">
                            ...
                            <div class="listing-image-slider MySlider overflow-hidden position-relative">
                                <div class="listing-image-slider-inner h-100 w-100">
                                    <a href="' . $permalink . '" class="d-inline-block h-100">
                                        <img src="' . esc_url($specialImage) . '" alt="' . esc_attr($title) . '" title="' . esc_attr($title) . '" loading="lazy" decoding="async" class="card-thumbnail" width="365" height="270" style="padding:10px 10px;width:100%;height:100%;" />
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="card-content-wrapper px-10 position-relative">
                                ...
                                <div class="vehicle-meta-block mb-2 mt-3 d-flex align-items-center" style="justify-content: flex-start;">
                                    <span class="font-weight-bold font-md" style="color: #454545;">STOCK #: ' . esc_html($stock_number) . '</span>
                                ...
                                <div class="vehicle-meta-block mb-2 d-flex align-items-center" style="justify-content: flex-start;">
                                    <span class="font-weight-bold font-md" style="color: #454545;">MILEAGE: ' . (is_numeric($odometer) ? esc_html(number_format((int)$odometer)) : '') . '</span>
                                </div>
                                <div class="vehicle-meta-block mb-2 d-flex align-items-center" style="justify-content: flex-start;">
                                    <span class="font-weight-bold font-md" style="color: #454545;">CERTIFIED: ' . esc_html($certified ? $certified : '') . '</span>
                                </div>
                                <div class="vehicle-meta-block mb-3 d-flex align-items-center" style="justify-content: flex-start;">
                                    <span class="font-weight-bold font-md" style="color: #454545;">DRIVETRAIN: ' . esc_html($drivetrain ? $drivetrain : '') . '</span>
                                </div>
        ...
        if (!empty($vins)) {
            ...
            foreach ($vins as $post_id => $vin) {
                ...
                $output .= '<div class="col-12 col-sm-6 col-md-6 col-xl-3 px-10 mb-20">
                    <div class="manager-special-card position-relative h-100 33">
