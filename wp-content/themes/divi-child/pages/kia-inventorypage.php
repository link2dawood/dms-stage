...
// Redirect to clean URL (no parameters) - Kia page should have no search/query params
if (!empty($_GET)) {
...
$is_kia_inventory = true;

// Checkbox Options (same as new-inventorypage for filter compatibility)
                    ...
                    <div
                        ...
                        <div class="inventory-filterbar">
                            ...
                            <div class="inventory-filters-main-wrapper inventory-filters-mobile-sidebar">
								...
								<!-- Kia page: New vehicles only, Make filter hidden (always Kia) -->
