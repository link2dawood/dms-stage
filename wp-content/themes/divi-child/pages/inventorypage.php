<?php /* Template Name: inventorypage */ ?>
<?php
global $post;
...
// 			echo divi_child_rankmath_breadcrumbs(); 
            $bannerGroups = array(
                ...
                // Add other banner groups as needed...
            );
...
<!--                                 <?php echo createSearchBar('main-search-filters w-100 position-relative', null, 'main-search-icon'); ?> -->
								...
								<?php $is_new_inventory = is_page( 'used-vehicles-durango-colorado' ); ?>
								...
								<div class="vehicle-condition-filter-wrap">
									<div class="vehicle-condition-filter-block">
										...
										<input type="radio"
											   ...
											   id="vehicle-condition-filter-new"  value="new" />
									</div>
									<div class="vehicle-condition-filter-block">
									...
									<div class="vehicle-condition-filter-block">
										...
										<input type="radio"
											   ...
											   value="pre-owned" checked />
									</div>
								</div>
                                <?php echo checkboxOptionLoader('Year', 'fake-year');
